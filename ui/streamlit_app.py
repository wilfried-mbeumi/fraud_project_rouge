...
# ── État du modèle ────────────────────────────────────────────────────────────
st.markdown('<div class="card"><div class="card-title">État du modèle</div>', unsafe_allow_html=True)
...
<div class="metric-row">
  <div class="metric-box"><div class="metric-val">✅</div><div class="metric-lbl">Modèle chargé</div></div>
...
<p class="status-ok">● Modèle intégré localement</p>
""", unsafe_allow_html=True)
